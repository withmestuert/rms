...
class UserServiceTest {
    ...
    @Mock private com.rms.backend.security.AuthSessionRepository sessions;
    ...
    void setUp() {
        ...
        sampleRequest.setPassword("secure-password-123");
        ...
        sampleRequest.setRole("REPRESENTATIVE");
    ...
    void testGetAllUsers() {
        when(userRepository.findByOwnerIdOrId(99L, 99L)).thenReturn(List.of(sampleUser));
        ...
        assertEquals("REPRESENTATIVE", users.get(0).getRole());
    }
    ...
    void testUpdateUserSuccess() {
        when(userRepository.findForUpdate(1L)).thenReturn(Optional.of(sampleUser));
    ...
    void testDeleteUserNotFound() {
        when(userRepository.findForUpdate(999L)).thenReturn(Optional.empty());
